...
// Ответ: выходит ошибка, т.к. не вызывается конструктор базового класса
// class Rabbit extends Object отличается от class Rabbit тем, что имеет доступ к статическим методам Object
